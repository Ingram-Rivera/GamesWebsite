...
const showblock2 = document.querySelectorAll('.mini-grid2 div')
const showw = 4 
let showIndex = 0
...
// show score in second mini grid
function showScoreInGrid(){
    scoreShow.innerHTML(Score => {
        showblock2[score + index].classList.add('item3')
    })
